...
public class BankTest {
    ...
    public void add_account_to_bank() {
        ...
        assertEquals(checkings, bank.findAccount(QUICK_ID));
    }
    ...
    public void retrieve_one_account_from_bank() {
        bank.addAccount(checkings);
        Account actual = bank.findAccount(QUICK_ID);
        assertEquals(QUICK_ID, actual.getAccountId());//bank class->getAccounts method->get ID from hash map-> retrieve name from checkings class method
    }
